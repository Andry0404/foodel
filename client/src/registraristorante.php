    ...
    <div class="signup-wrapper">
        <div class="signup">
            <form name="signup-form" action="../../server/src/crearistorante.php" method="get">
                <h2 class="text-centered">Crea il tuo ristorante</h2>
                <table>
                    <tr>
                    ...
                    <tr>
                        <td><label for="num_telefono">Numero di telefono:</label></td>
                        <td><input type="text" id="num_telefono" name="num_telefono"><br><br></td>
                    </tr>
                    <tr hidden>
                        <td><input type="number" id="lastIndex" name="lastIndex" value=<?php print($lastIndex) ?> /></td>
                    </tr>
                </table>

                <div style="display: flex; justify-content: center;">
                    <input style="border-radius: 180px; border: 0px; padding: 4px 8px 4px 8px; cursor: pointer;" type="submit" value="Crea il tuo ristorante">
                </div>
            </form>
        </div>
    </div>
