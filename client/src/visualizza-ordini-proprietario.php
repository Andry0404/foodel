...
$queryGetIdRistorante = "SELECT * FROM Possiede WHERE id_proprietario=".$_SESSION['userID'].";";
$queryGetIdRistoranteResult = mysqli_query($connection, $queryGetIdRistorante);
$ristorante = mysqli_fetch_array($queryGetIdRistoranteResult);
$id_ristorante = $ristorante["id_ristorante"];

$queryGetOrdini = "SELECT * FROM Ordina_da WHERE id_ristorante=" . $id_ristorante . " ORDER BY data_ordine;";
...
<body>
    ...
    <div class="ristorante-info">
        <div class="ristorante-item" style="padding-bottom: 20px">
            <h2 style='margin-bottom: 2px'>Ordini ricevuti per il tuo ristorante</h2>
            <?php
            if (count($ordini) === 0) {
